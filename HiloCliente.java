...
public class HiloCliente extends Thread {
    ...
    private String[][] preguntasRespuestas = {
        {"¿Cual es el continente más grande?", "Asia"},
        {"¿Quién pinto la Mona Lisa?", "Leonardo da Vinci"},
        {"¿En qué año se fundo la ONU?", "1945"},
        {"¿Cual es el rio mas largo del mundo?", "Amazonas"},
        {"¿Cual es el idioma más hablado en el mundo?", "Mandarín"}
    };
